...
// Execute the query
$query = mysqli_query($con, "INSERT INTO tblproducts (CategoryName, CompanyName, ProductName, ProductPrice, quantity) VALUES ('$catname', '$company', '$pname', '$pprice', '$quantity')");
...
<div class="invalid-feedback">Please provide Quantity of product.</div>
</div>
</div>
