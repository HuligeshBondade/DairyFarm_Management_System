...
$query=mysqli_query($con,"update tblproducts set CategoryName='$catname',CompanyName='$company',ProductName='$pname',ProductPrice='$pprice',Quantity='$quantity' where id='$pid'"); 
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $result['Quantity'];?>" name="Quantity" required>
